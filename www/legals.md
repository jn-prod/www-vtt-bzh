...
description: "Mentions légales, politique de confidentialité et gestion des cookies pour vtt.bzh."
---
...
- **Statut** : particulier sans activité commerciale (le site est édité à titre personnel)
...
- **Hébergement statique** : GitHub Pages — _GitHub, Inc._, 88 Colin P. Kelly Jr Street, San Francisco, CA 94107, USA. Voir leur [politique de confidentialité](https://docs.github.com/site-policy/privacy-policies/github-general-privacy-statement).
- **CDN et distribution** : Cloudflare — _Cloudflare, Inc._, 101 Townsend Street, San Francisco, CA 94107, USA. Voir leur [politique de confidentialité](https://www.cloudflare.com/privacypolicy/).
- **Base de données et fonctions edge** : Supabase — _Supabase Inc._, San Francisco, USA. Le projet est hébergé en Europe (région `eu-west-1`). Voir leur [politique de confidentialité](https://supabase.com/privacy).
- **Notification interne de modération** : Telegram — _Telegram FZ-LLC_, Émirats Arabes Unis. Utilisé pour notifier l'éditeur lors de chaque nouvelle publication via le formulaire (finalité de modération).
...
- droit d'**accès** (savoir quelles données sont conservées vous concernant)
...
Pour exercer ces droits, écrivez à <nicolas@vtt.bzh> en précisant votre demande. Une réponse vous sera apportée dans un délai maximal d'un mois.
